...
<div class="card">
        ...
        <form id="profileForm" enctype="multipart/form-data">
            ...
            <div class="profile-layout">
                ...
                <div>
                    ...
                    <div class="modal-form-grid">
                        <div class="mb-4">
                            <label class="block text-muted mb-2"><?php echo __('business_name_label'); ?> <span class="text-danger">*</span></label>
                            <input type="text" name="razon_social" class="form-control" value="<?php echo htmlspecialchars($user['razon_social']??''); ?>" required>
                        </div>
                        <div class="mb-4">
                            <label class="block text-muted mb-2"><?php echo __('trade_name_label'); ?></label>
                            <input type="text" name="nombre_negocio" class="form-control" value="<?php echo htmlspecialchars($user['nombre_negocio']??''); ?>">
                        </div>
                    </div>
                    ...
                    <div class="modal-form-grid">
                        <div class="mb-4">
                            ...
                            <input type="text" name="nif" id="inputNif" class="form-control" value="<?php echo htmlspecialchars($user['nif']??''); ?>" style="text-transform:uppercase;" oninput="this.value=this.value.toUpperCase()" onblur="validateNifVisual(this)" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="roi" class="form-control" value="<?php echo htmlspecialchars($user['roi']??''); ?>" style="text-transform:uppercase;" oninput="this.value=this.value.toUpperCase()">
                        </div>
                    </div>
                    
                    <div class="mb-4">
                        <label class="block text-muted mb-2"><?php echo __('phone_label'); ?> <span class="text-danger">*</span></label>
                        <input type="tel" name="telefono" class="form-control" value="<?php echo htmlspecialchars($user['telefono']??''); ?>" required>
                    </div>

                    <div class="modal-form-grid">
                        <div class="mb-4">
                            <label class="block text-muted mb-2"><?php echo __('address_label'); ?> <span class="text-danger">*</span></label>
                            <input type="text" name="direccion" class="form-control" value="<?php echo htmlspecialchars($user['direccion']??''); ?>" required>
                        </div>
                        <div class="mb-4">
                            <label class="block text-muted mb-2"><?php echo __('key_users_modal_address_num'); ?> <span class="text-danger">*</span></label>
                            <input type="text" name="direccion_numero" class="form-control" value="<?php echo htmlspecialchars($user['direccion_numero']??''); ?>" required>
                        </div>
                    </div>

                    <div class="modal-form-grid">
                        <div class="mb-4">
                            <label class="block text-muted mb-2"><?php echo __('country_label'); ?> <span class="text-danger">*</span></label>
                            <select name="id_pais" id="selectPais" class="form-control" onchange="toggleAddressFields()" required></select>
                        </div>
                        <div class="mb-4">
                            <label class="block text-muted mb-2"><?php echo __('zip_code_label'); ?> <span class="text-danger">*</span></label>
                            <input type="text" name="cp" class="form-control" value="<?php echo htmlspecialchars($user['cp']??''); ?>" required>
                        </div>
                    </div>
                    
                    <div id="spainFields" class="hidden modal-form-grid">
                        <div class="mb-4">
                            <label class="block text-muted mb-2"><?php echo __('province_label'); ?> <span class="text-danger">*</span></label>
                            <select name="id_provincia" id="selectProvincia" class="form-control" onchange="loadCiudades(this.value)">
                                <option value=""><?php echo __('key_users_modal_select'); ?></option>
                            </select>
                        </div>
                        <div class="mb-4">
                            <label class="block text-muted mb-2"><?php echo __('city_label'); ?> <span class="text-danger">*</span></label>
                            <select name="id_ciudad" id="selectCiudad" class="form-control"></select>
                        </div>
                    </div>

                    <div class="text-right mt-4">
                        <button type="submit" class="btn-primary"><?php echo __('save_changes'); ?></button>
                    </div>
                </div>
            </div>
        </form>
    ...
    <div id="appearance" class="tab-content hidden">
        <form id="themeForm">
            ...
            <p class="text-muted mb-4"><?php echo __('default_appearance_desc'); ?></p>
            ...
            <div class="text-right mt-4">
                <button type="submit" class="btn-primary"><?php echo __('save_appearance'); ?></button>
            </div>
        </form>
    </div>
...
function validateNifVisual(input) {
    ...
    if(errorMsg) { if(valid) errorMsg.classList.add('hidden'); else errorMsg.classList.remove('hidden'); }
}
...
const handleSave = async (e) => {
    ...
    if (form.id === 'profileForm') {
        ...
        if(pais === 'ES' && nif && !isValidNif(nif)) { showToast('<?php echo __('nif_error'); ?>', 'error'); return; }
    }
